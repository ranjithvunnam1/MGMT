...
<html lang="en">
    ...
    <head>
        ...
        <title>Explore - explore to world around you...</title>
                ...
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1 slider">
                        <div class="flexslider">
                            <ul class="slides">
                                <li data-thumb="resources/img/slider/1.jpg">
                                    <img src="resources/img/slider/1.jpg">
                                ...
                                <li data-thumb="resources/img/slider/2.jpg">
                                    <img src="resources/img/slider/2.jpg">
                                    <div class="flex-caption">
                                    	Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit 
                                    	lobortis nisl ut aliquip ex ea commodo consequat.
                                    </div>
                                </li>
                                <li data-thumb="resources/img/slider/3.jpg">
                                    <img src="resources/img/slider/3.jpg">
                                    <div class="flex-caption">
                                    	Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et. 
                                    	Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et. 
                                    	Lorem ipsum dolor sit amet, consectetur.
                                ...
                                <li data-thumb="resources/img/slider/4.jpg">
                                    <img src="resources/img/slider/4.jpg">
                                    <div class="flex-caption">
                                    	Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit 
                                    	lobortis nisl ut aliquip ex ea commodo consequat.
                                    </div>
	            ...
	            <div class="row">
	            	<div class="col-sm-3">
		                <div class="work wow fadeInUp">
		                    <img src="resources/img/portfolio/work1.jpg" alt="Lorem Website" data-at2x="resources/img/portfolio/work1.jpg">
		                    <h3>Lorem Website</h3>
		                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor...</p>
		                    <div class="work-bottom">
		                        <a class="big-link-2 view-work" href="resources/img/portfolio/work1.jpg"><i class="fa fa-search"></i></a>
	                ...
	                <div class="col-sm-3">
		                <div class="work wow fadeInDown">
		                    <img src="resources/img/portfolio/work2.jpg" alt="Ipsum Logo" data-at2x="resources/img/portfolio/work2.jpg">
		                    <h3>Ipsum Logo</h3>
		                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor...</p>
		                    <div class="work-bottom">
		            ...
		            <div class="col-sm-3">
		                <div class="work wow fadeInUp">
		                    <img src="resources/img/portfolio/work3.jpg" alt="Dolor Prints" data-at2x="resources/img/portfolio/work3.jpg">
		                    <h3>Dolor Prints</h3>
		                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor...</p>
		                    <div class="work-bottom">
		            ...
		            <div class="col-sm-3">
		                <div class="work wow fadeInDown">
		                    <img src="resources/img/portfolio/work4.jpg" alt="Sit Amet Website" data-at2x="resources/img/portfolio/work4.jpg">
